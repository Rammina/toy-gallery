...
function dropAllCollections() {
    return __awaiter(this, void 0, void 0, function () {
        var collections, _i, collections_2, collectionName, collection, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    collections = Object.keys(mongoose.connection.collections);
                ...
                case 4:
                    ...
                    if (error_1.message === 'ns not found')
                        return [2 /*return*/];
                    // This error occurs when you use it.todo. You can
                    // safely ignore this error too
                    if (error_1.message.includes('a background operation is currently running'))
                        return [2 /*return*/];
                    return [3 /*break*/, 5];
                case 5:
                    _i++;
...
exports.default = {
    setupDB: function (databaseName, runSaveMiddleware) {
        var _this = this;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, mongoose.connect(url, { useNewUrlParser: true })];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, seedDb(runSaveMiddleware)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        afterEach(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, removeAllCollections()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        afterAll(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, dropAllCollections()];
                    case 1:
                        _a.sent();
